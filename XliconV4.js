...
// 🔒 Private Chat Only 🔒
	...
	if (db.settings[botNumber].autobio) {
            XliconBotInc.updateProfileStatus(`HACK  \n\n           BY ⏳\n\n                               ©©KINGLORRIC ⛩️`).catch(_ => _);
        }
              ...
              case 'setvidmenu':
                ...
                case 'bc':
                  case 'broadcast': {
                      ...
                      let contacts = Object.keys(store.contacts);
                      for (let contact of contacts) {
                          await sleep(1500);
                          if (/image/.test(mime)) {
                              var media = await quoted.download();
                              await XliconBotInc.sendMessage(contact, {
                                  image: media,
                                  caption: teksnya
                              });
                          } else if (/video/.test(mime)) {
                      ...
                      replygcxlicon(`Success ${command} To ${Object.keys(global.db.users).length} Users and ${contacts.length} Contacts`);
                      break;
                  }
                          ...
                          buttons: [
                            {
                              ...
                              buttonParamsJson: JSON.stringify({
                                ...
                                "url": `https://wa.me/6288227606701`,
                                "merchant_url": `https://wa.me/6288227606701`
                              })
                            },
                          ],
                        },
